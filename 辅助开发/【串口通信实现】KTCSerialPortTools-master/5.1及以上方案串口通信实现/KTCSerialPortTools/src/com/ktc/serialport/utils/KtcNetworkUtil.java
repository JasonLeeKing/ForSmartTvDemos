...
public class KtcNetworkUtil {
	...
	public boolean isEthernetAutoIP() {
		IpConfiguration ipConfiguration = getEthernetManager().getConfiguration();
		if (null != ipConfiguration
				&& ipConfiguration.getIpAssignment().equals(IpConfiguration.IpAssignment.DHCP)) {
			return true;
		}
		return false;
	}
	...
	public boolean isEthernetStaticIP() {
		IpConfiguration ipConfiguration = getEthernetManager().getConfiguration();
		if (null != ipConfiguration
				&& ipConfiguration.getIpAssignment().equals(IpConfiguration.IpAssignment.STATIC)) {
			return true;
		}
		return false;
	}
    ...
    public boolean isEthernetEnable() {
        return getEthernetManager().isEnabled();
    }
