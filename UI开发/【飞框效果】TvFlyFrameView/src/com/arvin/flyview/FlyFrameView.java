 ...
 * @since 2018.5.18
 */
public class FlyFrameView<X extends View> implements ViewTreeObserver.OnGlobalFocusChangeListener, 
	ViewTreeObserver.OnScrollChangedListener, 
	ViewTreeObserver.OnGlobalLayoutListener, 
	ViewTreeObserver.OnTouchModeChangeListener {
	
    private String TAG = FlyFrameView.class.getSimpleName();
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        borderEffect = new FlyFrameEffect();
        mView = (X) new View(context, attrs, defStyleAttr);
    }

    public FlyFrameView(X view) {
        this.mView = view;
        borderEffect = new FlyFrameEffect();
    }
    public FlyFrameView(X view,Effect effect) {
        this.mView = view;
        borderEffect =effect;
    }

    public FlyFrameView(Context context, int resId) {
    ...
    public <T extends FlyFrameEffect> T getEffect() {
