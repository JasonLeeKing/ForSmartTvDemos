...
import com.arvin.flyview.FlyFrameView.Effect;

/**
 * @author Arvin
 * @since 2018.5.18
 */
public class FlyFrameEffect implements Effect {
    private String TAG = FlyFrameEffect.class.getSimpleName();
        ...
        try {
            ...
            scaleAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public synchronized void onAnimationUpdate(ValueAnimator animation) {
                    int width = (int) Integer.valueOf(animation.getAnimatedValue("width").toString());
                    int height = (int) Integer.valueOf(animation.getAnimatedValue("height").toString());
                    float translationX = (float) Float.valueOf(animation.getAnimatedValue("translationX").toString());
                    float translationY = (float) Float.valueOf(animation.getAnimatedValue("translationY").toString());
    ...
    protected List<View> attacheViews = new ArrayList<View>();
    protected Map<View, AdapterView.OnItemSelectedListener> onItemSelectedListenerList = new HashMap<View, AdapterView.OnItemSelectedListener>();
